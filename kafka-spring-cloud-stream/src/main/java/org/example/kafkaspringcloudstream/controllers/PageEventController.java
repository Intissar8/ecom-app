...
public class PageEventController {
    ...
    @Autowired
    private StreamBridge streamBridge; // the cluster that permits to publish messages in a broker
    @Autowired
    ...
    public PageEvent publish(String name,String topic){
          ...
          streamBridge.send(topic,event);//we send the topic the object event
        return event;
    }
